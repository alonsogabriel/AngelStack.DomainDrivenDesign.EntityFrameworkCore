...
namespace ConsoleTests.Migrations
{
    ...
    [Migration("20250818125320_Change phone code column names")]
    partial class Changephonecodecolumnnames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleTests.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleTests.Entities.User", b =>
                {
                    b.HasOne("ConsoleTests.Entities.Person", "Person")
                        .WithOne()
                        .HasForeignKey("ConsoleTests.Entities.User", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("AngelStack.DomainDrivenDesign.ValueObjects.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("AngelStack.DomainDrivenDesign.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
                            ...
                            b1.OwnsOne("AngelStack.DomainDrivenDesign.ValueObjects.AreaCode", "AreaCode", b2 =>
                                {
                                    b2.Property<int>("PhoneNumberUserId")
                                        .HasColumnType("int");
                            ...
                            b1.OwnsOne("AngelStack.DomainDrivenDesign.ValueObjects.CountryCode", "CountryCode", b2 =>
                                {
                                    b2.Property<int>("PhoneNumberUserId")
                                        .HasColumnType("int");
                            ...
                            b1.Navigation("AreaCode");

                            b1.Navigation("CountryCode")
                                .IsRequired();
                        });

                    b.OwnsOne("AngelStack.DomainDrivenDesign.ValueObjects.Username", "Username", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
